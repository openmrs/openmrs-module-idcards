            ...
            <fo:block text-align="center">
                <fo:table table-layout="fixed" start-indent="(100% - 168mm - 3mm) div 2"
                    ...
                    <fo:table-body>
                        ...
                        <xsl:variable name="padding" select="'00000000000'"/>
                                                        ...
                                                        <fo:instream-foreign-object >
                                                            <barcode:barcode
                                                                ...
                                                                <barcode:code39>
                                                                    ...
                                                                    <barcode:interchar-gap-width>2.5mw</barcode:interchar-gap-width>
                                                                    
                                                                    <barcode:module-width>0.22mm</barcode:module-width>
                                                                    -->
