...
/**
 * Handles the page that lets the user print out current patient's id cards
 */
@Controller
public class ReprintIdcardsFormController {
	
	/**
	 * Show the page to the user.
	 */
	@SuppressWarnings("unchecked")
	@RequestMapping(method = RequestMethod.GET, value = "/module/idcards/reprintIdcards")
